mantenimiento_tractorescevichecevichemantenimiento_tractores
...
CREATE TABLE reportes (
    ...
    fecha DATE NOT NULL,
    observaciones TEXT,
    archivo_reporte VARCHAR(255),55555
    FOREIGN KEY (tractor_id) REFERENCES tractores(id) ON DELETE CASCADE,
    FOREIGN KEY (usuario_id) REFERENCES usuarios(id) ON DELETE CASCADE
);
...
VALUES (
    ...
    'admin@gmail.com',
    '$2y$10$P2FLpKQEpVmK/oOo16Bu6uL5XmW9BbS/EmrT.VAhhNE59PeDblc1W',
    1
); -- contraseña: admin123
